...
def compute_degree_cm_mAP(final_results, synset_names, log_dir, degree_thresholds=[360], shift_thresholds=[100], iou_3d_thresholds=[0.1], iou_pose_thres=0.1, use_matches_for_pose=False):
    ...
    # Diff to NOCS: Skip IoU computation
    '''
    fig_iou = plt.figure()
    ...
    # Diff to NOCS: Skip heatmap plotting
    '''
    for cls_id in range(1, num_classes):
        class_name = synset_names[cls_id]
        print(class_name)
    ...
    '''
    print('10 degree : {:.1f}'.format(pose_aps[-1, degree_thres_list.index(10),shift_thres_list.index(10000)] * 100))
    print('60 degree {:.1f}'.format(pose_aps[-1, degree_thres_list.index(60),shift_thres_list.index(10000)] * 100))
